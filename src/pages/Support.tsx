...
const Support = () => {
  ...
  return <main id="main" className="container py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start lg:items-stretch">
          {/* Contact Form */}
          <section>
            <ContactForm type="contact" title="Get In Touch" description="Have questions about supporting our community? We're here to help connect you with the right opportunities." />
